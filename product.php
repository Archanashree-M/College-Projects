		...
		<div class="page-wrapper">
			<div class="page-content">
			    <div class="row" style="margin: 0px 1px 15px 2px;">
						  ...
						  <div class="col-lg-4">
						      <a href="executive-add.php"><button type="button" class="btn btn-warning btn-sm"><i class='bx bx-user-plus'></i> Add New Product</button></a>
						  </div>
				</div>		  
			    <div class="card">
					<div class="card-body">
...
<script>
 ...
 function getData(){			   
	var dataTable = $('#example2').DataTable( {									     
        ...
        "destroy":true,
        "ajax":{
			url :"data-tables/products-data-table.php", // json datasource
