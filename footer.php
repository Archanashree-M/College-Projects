...
$statements = $pdo->prepare("SELECT * from products where status='1' and product_type='1' limit 3");
...
?>
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="preview.php?id=<?=$data['id']?>" ><span class="d-block width-75 text-center"><img class="img-fluid" src="<?=$data['p_image']?>" alt="Image Description"></span></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                        <h5 class="product-item__title mb-0"><span  class="text-blue font-weight-bold"><?=$data['product_name']?></span></h5>
                                        <div class="prodcut-price mt-auto">
                                            <div class="font-size-15">RS.<?=$data['selling_price']?></div>
                                        </div>
                                    </a>
                                    </div>
                                </li>
...
$statements = $pdo->prepare("SELECT * from products where status='1' and product_type='2' limit 3");
     $results = $statements->execute();
     $query = $statements->fetchAll(PDO::FETCH_ASSOC);
     $totals = $statements->rowCount(); 
$i=1;
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                ...
                                <div class="col pl-4 d-flex flex-column">
                                    ...
                                    <div class="prodcut-price mt-auto flex-horizontal-center">
                                        <ins class="font-size-15 text-decoration-none">RS.<?=$data['selling_price']?></ins>
                                        <del class="font-size-12 text-gray-9 ml-2">RS.<?=$data['actual_price']?></del>
                                    </div>
                                </a>
                                </div>
                            </li>
...
$statements = $pdo->prepare("SELECT * from products where status='1' and product_type='3' limit 3");
     $results = $statements->execute();
     $query = $statements->fetchAll(PDO::FETCH_ASSOC);
     $totals = $statements->rowCount(); 
$i=1;
                            ...
                            <div class="mb-4">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col pl-3">
                                        ...
                                        <a href="tel:+80080018588" class="font-size-20 text-gray-90">9025373302 </a><a href="tel:+0600874548" class="font-size-20 text-gray-90">9876543321</a>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-4">
            ...
            <div class="bg-gray-14 py-2">
                <div class="container">
                    <div class="flex-center-between d-block d-md-flex">
                        <div class="mb-3 mb-md-0">© <a href="#" class="font-weight-bold text-gray-90">Electro</a> - All rights Reserved-designed by archana</div>
                    ...
                    <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                        ...
                        <div class="js-scrollbar u-sidebar__body">
                            <div class="u-sidebar__content u-header-sidebar__content">
                                <form id="loginsignin" method="POST" class="js-validate">
                                    <!-- Login -->
                                    ...
                                    <form id="SignUp_Ecommerce">
                                        ...
                                        <div class="form-group">
                                            <div class="js-form-message js-focus-state">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" class="form-control" name="password" id="Password" placeholder="Password" aria-label="Password" aria-describedby="signupPasswordLabel" required
                                                    data-msg="Your password is invalid. Please try again."
                                        ...
                                        <div class="mb-2">
                                            <button type="submit" name="submit_btn" value="sign up"class="btn">Get Started</button>
                                        </div>
...
<script>
    ...
    $('#SignUp_Ecommerce').submit(function(e){
