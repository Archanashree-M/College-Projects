...
$statements = $pdo->prepare("SELECT tbl_cart.*,products.p_image as pro_image,products.product_name as pro_name,products.actual_price as act_price,products.selling_price as sel_price FROM `tbl_cart` INNER JOIN products ON tbl_cart.product_id=products.id WHERE tbl_cart.customer_id=$customer_id");
 ...
 ?>
                                <tr class="">
                                    ...
                                    <td class="d-none d-md-table-cell">
                                        <a href="#"><img class="img-fluid max-width-100 p-1 border border-color-1" src="<?=$data['pro_image']?>" alt="Image Description"></a>
                                    </td>

                                    <td data-title="Product">
                                        <a href="#" class="text-gray-90"><?=$data['pro_name']?></a>
                                    </td>

                                    <td data-title="Price">
                                        <span class=""><?=$data['sel_price']?></span>
                                    </td>
                                        ...
                                        <div class="pt-md-3">
                                            <div class="d-block d-md-flex flex-center-between">
                                                ...
                                                <div class="d-md-flex">
                                                    ...
                                                    <a href="check-out.php" class="btn btn-primary-dark-w ml-md-2 px-5 px-md-4 px-lg-5 w-100 w-md-auto d-none d-md-inline-block">Proceed to checkout</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
