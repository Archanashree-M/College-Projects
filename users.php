		...
		<div class="page-wrapper">
			<div class="page-content">
			    <div class="row" style="margin: 0px 1px 15px 2px;">
						  <div class="col-lg-8">
						      <h6 class="mb-0"><i class='bx bx-category'></i> View Users</h6>
						  </div>
						  <div class="col-lg-4">
						      <a href="users-add.php"><button type="button" class="btn btn-warning btn-sm"><i class='bx bx-user-plus'></i> Add New User</button></a>
						  </div>
				</div>		  
			    <div class="card">
					<div class="card-body">
    ...
    getData();
		     function getData(){			   
				var dataTable = $('#example2').DataTable( {									     
                    ...
                    "destroy":true,
                    "ajax":{
						url :"data-tables/users-datatable.php", // json datasource
...
function delete_users(id){
            ...
            if (result) {
                    ...
                    type: 'POST',
                    url: 'api/delete.php',
                    data: {type:'delete_users',delete_id:id},                  
